...
public class Util {
    ...
    public static BufferedReader getReaderPlain(InputStream in) {
	...
	public static BufferedReader getReader(boolean customerSuppliedKey, String objectName, String bucketName,
			String key, Optional<String> csekhash) {
		...
		try {
            ...
            try {
                objectData = StorageFactory.downloadCSKEncryptedObject(storage, bucketName, objectName, key, csekhash.get());
            } catch (Exception e) {
